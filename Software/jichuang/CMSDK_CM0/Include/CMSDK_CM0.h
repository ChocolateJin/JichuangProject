...
/******  CMSDK Specific Interrupt Numbers *********************************************************/
  ...
  BTN_R_IRQn                 = 28,      /*!< GPIO 0 individual pin 12                          */
  BTN_L_IRQn                 = 29,      /*!< GPIO 0 individual pin 13                          */
  BTN_D_IRQn                 = 30,      /*!< GPIO 0 individual pin 14                          */
  BTN_U_IRQn                 = 31,      /*!< GPIO 0 individual pin 15                          */
} IRQn_Type;
